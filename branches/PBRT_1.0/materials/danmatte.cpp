//mimics matte. just experimenting with adding new materials.
...
class danMatte : public Material {
public:
	// Matte Public Methods
	danMatte(Reference<Texture<Spectrum> > kd,
...
extern "C" DLLEXPORT Material * CreateMaterial(const Transform &xform,
	...
	return new danMatte(Kd, sigma, bumpMap);
}
