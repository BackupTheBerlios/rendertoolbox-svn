function Render_MakeWriteRifFiles(objectMaterialParams,lightMaterialParams,currentConditions,currentConditionNumber)
...
%get some stats
objectsFolder=['objects_' int2str(currentConditionNumber)];
...
lightsFolder=['lights_' int2str(currentConditionNumber)];
...
for i=1:numWavelengths
    ...
    materialsFile=['materials_' int2str(currentConditionNumber) '/obj_material_' currentWavelengthValue '.rad'];
    S = '';
    ...
    fid = fopen([rif_name,'_',currentWavelengthValue,'.rif'],'w');  
